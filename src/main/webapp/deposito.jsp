...
<html lang="en">
  ...
  <body class="vh-100">
    ...
    <div class="container bg-light bg-gradiente rounded p-5 mt-5 shadow">
      <h2 class="text-center text-primary">Depositar</h2>
      <form action="deposito" method="post">
        ...
        <label for="email">Email:</label>
          ...
          />
          <label for="amount" class= "mt-2">Monto a depositar:</label>
          <input
            type="number"
            name="monto"
            class="form-control mt-2"
        ...
        <button type="submit" value="depositar" class="btn btn-primary mt-3">
          Realizar depósito
        </button>
      </form>
